 ...
 *
 */
export interface FetterInfoExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toFetterInfoExcelConfigDataType(
    json: string,
  ): FetterInfoExcelConfigDataType[] {
   ...
   * @param value
   */
  public static fetterInfoExcelConfigDataTypeToJson(
    value: FetterInfoExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('FetterInfoExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  FetterInfoExcelConfigDataType: o(
    [
      ...
      {
        json: 'avatarConstellationAfterTextMapHash',
        js: 'avatarConstellationAfterTextMapHash',
        typ: 0,
      },
      {
        json: 'avatarConstellationBeforTextMapHash',
        js: 'avatarConstellationBeforTextMapHash',
        typ: 0,
      },
      {
        json: 'avatarDetailTextMapHash',
        js: 'avatarDetailTextMapHash',
        typ: 0,
      },
      { json: 'avatarId', js: 'avatarId', typ: 0 },
      {
        json: 'avatarNativeTextMapHash',
        js: 'avatarNativeTextMapHash',
        typ: 0,
      },
      { json: 'avatarTitleTextMapHash', js: 'avatarTitleTextMapHash', typ: 0 },
      {
        json: 'avatarVisionAfterTextMapHash',
        js: 'avatarVisionAfterTextMapHash',
        typ: 0,
      },
      {
        json: 'avatarVisionBeforTextMapHash',
        js: 'avatarVisionBeforTextMapHash',
        typ: 0,
      },
