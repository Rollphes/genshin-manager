 ...
 *
 */
export interface DungeonLevelEntityConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toDungeonLevelEntityConfigDataType(
    json: string,
  ): DungeonLevelEntityConfigDataType[] {
   ...
   * @param value
   */
  public static dungeonLevelEntityConfigDataTypeToJson(
    value: DungeonLevelEntityConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('DungeonLevelEntityConfigDataType'))),
      null,
      2,
    )
  }
