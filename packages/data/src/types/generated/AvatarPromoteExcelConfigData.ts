 ...
 *
 */
export interface AvatarPromoteExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarPromoteExcelConfigDataType(
    json: string,
   ...
   * @param value
   */
  public static avatarPromoteExcelConfigDataTypeToJson(
    value: AvatarPromoteExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarPromoteExcelConfigDataType'))),
      null,
      2,
    )
  }
