 ...
 *
 */
export interface MaterialExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toMaterialExcelConfigDataType(
    json: string,
  ): MaterialExcelConfigDataType[] {
   ...
   * @param value
   */
  public static materialExcelConfigDataTypeToJson(
    value: MaterialExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('MaterialExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  MaterialExcelConfigDataType: o(
    [
      ...
      {
        json: 'destroyReturnMaterial',
        js: 'destroyReturnMaterial',
        typ: a('any'),
      },
      {
        json: 'destroyReturnMaterialCount',
        js: 'destroyReturnMaterialCount',
        typ: a('any'),
      },
      ...
      { json: 'id', js: 'id', typ: 0 },
      {
        json: 'interactionTitleTextMapHash',
        js: 'interactionTitleTextMapHash',
        typ: 0,
      },
  ...
  Dpakkallbgn: ['MATERIAL_SYS_TYPE_BEYOND', 'MATERIAL_SYS_TYPE_NONE'],
  ...
  ItemType: ['ITEM_MATERIAL', 'ITEM_VIRTUAL'],
  UseOp: [
