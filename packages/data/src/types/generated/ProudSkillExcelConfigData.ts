 ...
 *
 */
export interface ProudSkillExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export enum Cijgpjncakn {
  ProudSkillDisplayAqQuestUnlock = 'PROUD_SKILL_DISPLAY_AQ_QUEST_UNLOCK',
...
export class Convert {
   ...
   * @param json
   */
  public static toProudSkillExcelConfigDataType(
    json: string,
  ): ProudSkillExcelConfigDataType[] {
   ...
   * @param value
   */
  public static proudSkillExcelConfigDataTypeToJson(
    value: ProudSkillExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('ProudSkillExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  ProudSkillExcelConfigDataType: o(
    [
      ...
      { json: 'DGPODKJBFHL', js: 'DGPODKJBFHL', typ: r('Dgpodkjbfhl') },
      { json: 'ELIEKALFBPD', js: 'ELIEKALFBPD', typ: a(0) },
      { json: 'filterConds', js: 'filterConds', typ: a(r('FilterCond')) },
      { json: 'GDDGHEPGDMB', js: 'GDDGHEPGDMB', typ: 0 },
      { json: 'GLGGNGIAGEM', js: 'GLGGNGIAGEM', typ: a(0) },
  ...
  Dgpodkjbfhl: o([{ json: 'value', js: 'value', typ: 0 }], false),
  AddProp: o(
    [
  ...
  Cijgpjncakn: [
    'PROUD_SKILL_DISPLAY_AQ_QUEST_UNLOCK',
