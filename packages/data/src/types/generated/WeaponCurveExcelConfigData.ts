 ...
 *
 */
export interface WeaponCurveExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toWeaponCurveExcelConfigDataType(
    json: string,
  ): WeaponCurveExcelConfigDataType[] {
   ...
   * @param value
   */
  public static weaponCurveExcelConfigDataTypeToJson(
    value: WeaponCurveExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('WeaponCurveExcelConfigDataType'))),
      null,
      2,
    )
  }
