 ...
 *
 */
export interface AnimalCodexExcelConfigDataType {
  /**
   *
   */
  IEDNJFPPPHD: number[]
...
export class Convert {
   ...
   * @param json
   */
  public static toAnimalCodexExcelConfigDataType(
    json: string,
  ): AnimalCodexExcelConfigDataType[] {
   ...
   * @param value
   */
  public static animalCodexExcelConfigDataTypeToJson(
    value: AnimalCodexExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AnimalCodexExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  ...
  Type: ['CODEX_ANIMAL', 'CODEX_MONSTER'],
}
