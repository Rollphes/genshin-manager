 ...
 *
 */
export interface TowerLevelExcelConfigDataType {
  /**
   *
   */
  AGEAANNELOI: number
...
export class Convert {
   ...
   * @param json
   */
  public static toTowerLevelExcelConfigDataType(
    json: string,
  ): TowerLevelExcelConfigDataType[] {
   ...
   * @param value
   */
  public static towerLevelExcelConfigDataTypeToJson(
    value: TowerLevelExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('TowerLevelExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  TowerLevelExcelConfigDataType: o(
    [
      ...
      {
        json: 'towerBuffConfigStrList',
        js: 'towerBuffConfigStrList',
        typ: a(''),
      },
    ],
    false,
