 ...
 *
 */
export interface AvatarCostumeExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarCostumeExcelConfigDataType(
    json: string,
  ): AvatarCostumeExcelConfigDataType[] {
   ...
   * @param value
   */
  public static avatarCostumeExcelConfigDataTypeToJson(
    value: AvatarCostumeExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarCostumeExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  AvatarCostumeExcelConfigDataType: o(
    [
      ...
      { json: 'CKELEGHPEIF', js: 'CKELEGHPEIF', typ: 0 },
      {
        json: 'controllerRemotePathHash',
        js: 'controllerRemotePathHash',
        typ: 3.14,
      },
      { json: 'HINKMCLODHL', js: 'HINKMCLODHL', typ: 3.14 },
      { json: 'descTextMapHash', js: 'descTextMapHash', typ: 0 },
      { json: 'NFLEEEMIDDO', js: 'NFLEEEMIDDO', typ: 0 },
      ...
      { json: 'IBGKLFJKPMJ', js: 'IBGKLFJKPMJ', typ: 3.14 },
