 ...
 *
 */
export interface DungeonEntryExcelConfigDataType {
  /**
   *
   */
  CFOKILJJLAJ: number[]
 ...
 *
 */
export interface SatisfiedCond {
  /**
   *
   */
  param1: number
...
export class Convert {
   ...
   * @param json
   */
  public static toDungeonEntryExcelConfigDataType(
    json: string,
  ): DungeonEntryExcelConfigDataType[] {
   ...
   * @param value
   */
  public static dungeonEntryExcelConfigDataTypeToJson(
    value: DungeonEntryExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('DungeonEntryExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  DungeonEntryExcelConfigDataType: o(
    [
      { json: 'CFOKILJJLAJ', js: 'CFOKILJJLAJ', typ: a(0) },
      { json: 'condComb', js: 'condComb', typ: r('CondComb') },
      { json: 'cooldownTipsDungeonId', js: 'cooldownTipsDungeonId', typ: a(0) },
      {
        json: 'descriptionCycleRewardList',
        js: 'descriptionCycleRewardList',
        typ: a(a(0)),
      },
