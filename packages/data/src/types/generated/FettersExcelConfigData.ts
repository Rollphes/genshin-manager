 ...
 *
 */
export interface FettersExcelConfigDataType {
  /**
   *
   */
  avatarId: number
...
export class Convert {
   ...
   * @param json
   */
  public static toFettersExcelConfigDataType(
    json: string,
  ): FettersExcelConfigDataType[] {
   ...
   * @param value
   */
  public static fettersExcelConfigDataTypeToJson(
    value: FettersExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('FettersExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  FettersExcelConfigDataType: o(
    [
      ...
      {
        json: 'voiceFileTextTextMapHash',
        js: 'voiceFileTextTextMapHash',
        typ: 0,
      },
      {
        json: 'voiceTitleLockedTextMapHash',
        js: 'voiceTitleLockedTextMapHash',
        typ: 0,
      },
