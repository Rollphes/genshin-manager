 ...
 *
 */
export interface TowerFloorExcelConfigDataType {
  /**
   *
   */
  bgImage: BgImage
...
export class Convert {
   ...
   * @param json
   */
  public static toTowerFloorExcelConfigDataType(
    json: string,
  ): TowerFloorExcelConfigDataType[] {
   ...
   * @param value
   */
  public static towerFloorExcelConfigDataTypeToJson(
    value: TowerFloorExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('TowerFloorExcelConfigDataType'))),
      null,
      2,
    )
  }
