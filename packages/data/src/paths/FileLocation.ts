...
export class FileLocation {
  ...
  /**
   * Create a FileLocation for TextMap
   * @param language - Language code
   * @param fileName - Optional file name
   */
  public static textMap(language: Language, fileName?: string): FileLocation {
    return new FileLocation({ type: 'textMap', language, fileName })
  }
