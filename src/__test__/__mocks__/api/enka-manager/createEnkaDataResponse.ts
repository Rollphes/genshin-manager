import type { EnkaDataResponse } from '@/infrastructure/types/api/enkaNetwork/responses'
 ...
 * @returns Mock EnkaDataResponse response
 */
export function createEnkaDataResponse(
  ...
  const avatarInfoList = withCharacters
    ? [
        {
          avatarId: 10000002,
          propMap: {
