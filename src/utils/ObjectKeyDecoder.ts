...
export class ObjectKeyDecoder {
    /**
     * character IDs that are not included in the character
     */
    private static readonly characterBlackIds: number[] = [
    ...
    constructor() {
        ...
        if (
            Client._hasCachedExcelBinOutputByName(
        ...
        jsonArray.forEach((json) => {
            ...
            switch (filename) {
                ...
                case 'AvatarExcelConfigData':
                    if (
                        ObjectKeyDecoder.characterBlackIds.includes(
                            obj.id as number,
                        )
                    )
                        break
                ...
                case 'ProudSkillExcelConfigData':
                    ...
                    ;(
                        cacheObject[
                            obj.proudSkillGroupId as string
                        ] as JsonObject
                    )[(obj.proudSkillId as number) % 100] = obj
                    break
