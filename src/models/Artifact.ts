...
export class Artifact {
    ...
    private static readonly blackArtifactIds: number[] = [
        ...
        23310, 23311, 23312, 23313, 23314, 23315, 23316, 23317, 23318, 23329,
        23330, 23334, 23335, 23336, 23337, 23338, 23339, 23340,
    ]
            ...
            if (Artifact.oneSetBonusIds.includes(this.setId)) {
                this.setDescriptions[1] = equipAffixJson
                    ? Client.cachedTextMap.get(
                          String(equipAffixJson.descTextMapHash),
                      )
                    : undefined
            } else {
                const equipAffixJsonBy2pc =
    ...
    private getSubStatProperties(appendPropIds: number[]): StatProperty[] {
        ...
        appendPropIds.forEach((propId) => {
            ...
            if (propValue) {
                result[propType] =
                    propValue + (artifactAffixJson.propValue as number)
            } else {
