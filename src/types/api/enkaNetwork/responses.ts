...
export interface AvatarInfoResponse {
   ...
   * @value Property data
   */
  readonly propMap: Readonly<Record<number, PropMapResponse>>
  /**
   ...
   */
  readonly fightPropMap: Readonly<Record<number, number>>
...
// ============================================
// Enka Account API Response Types
// ============================================
...
// ============================================
// Enka Status API Response Types
// ============================================
