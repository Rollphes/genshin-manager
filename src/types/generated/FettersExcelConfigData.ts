...
//
//   const fettersExcelConfigDataType = Convert.toFettersExcelConfigDataType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export type FettersExcelConfigDataType = {
    avatarId:                    number;
    fetterId:                    number;
    finishConds:                 any[];
...
export class Convert {
    public static toFettersExcelConfigDataType(json: string): FettersExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("FettersExcelConfigDataType")));
    }

    public static fettersExcelConfigDataTypeToJson(value: FettersExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("FettersExcelConfigDataType"))), null, 2);
    }
}
...
const typeMap: any = {
    "FettersExcelConfigDataType": o([
        { json: "avatarId", js: "avatarId", typ: 0 },
        { json: "fetterId", js: "fetterId", typ: 0 },
        { json: "finishConds", js: "finishConds", typ: a("any") },
        { json: "hideCostumeList", js: "hideCostumeList", typ: a(0) },
        { json: "isHiden", js: "isHiden", typ: true },
        { json: "openConds", js: "openConds", typ: a(r("OpenCond")) },
        { json: "showCostumeList", js: "showCostumeList", typ: a(0) },
        { json: "tips", js: "tips", typ: a(0) },
        { json: "type", js: "type", typ: 0 },
        { json: "voiceFile", js: "voiceFile", typ: "" },
        { json: "voiceFileTextTextMapHash", js: "voiceFileTextTextMapHash", typ: 0 },
        { json: "voiceTitleLockedTextMapHash", js: "voiceTitleLockedTextMapHash", typ: 0 },
        { json: "voiceTitleTextMapHash", js: "voiceTitleTextMapHash", typ: 0 },
    ], false),
    "OpenCond": o([
