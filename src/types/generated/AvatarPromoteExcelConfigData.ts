...
//
//   const avatarPromoteExcelConfigDataType = Convert.toAvatarPromoteExcelConfigDataType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export type AvatarPromoteExcelConfigDataType = {
    addProps:            AddProp[];
...
export class Convert {
    public static toAvatarPromoteExcelConfigDataType(json: string): AvatarPromoteExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("AvatarPromoteExcelConfigDataType")));
    }

    public static avatarPromoteExcelConfigDataTypeToJson(value: AvatarPromoteExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("AvatarPromoteExcelConfigDataType"))), null, 2);
    }
}
...
const typeMap: any = {
    "AvatarPromoteExcelConfigDataType": o([
        ...
        { json: "promoteAudio", js: "promoteAudio", typ: "" },
        { json: "promoteLevel", js: "promoteLevel", typ: 0 },
        { json: "requiredPlayerLevel", js: "requiredPlayerLevel", typ: 0 },
        { json: "scoinCost", js: "scoinCost", typ: 0 },
        { json: "unlockMaxLevel", js: "unlockMaxLevel", typ: 0 },
    ], false),
    "AddProp": o([
