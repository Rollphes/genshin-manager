...
export type InherentProudSkillOpen = {
...
export class Convert {
    public static toAvatarSkillDepotExcelConfigDataType(json: string): AvatarSkillDepotExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("AvatarSkillDepotExcelConfigDataType")));
    }

    public static avatarSkillDepotExcelConfigDataTypeToJson(value: AvatarSkillDepotExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("AvatarSkillDepotExcelConfigDataType"))), null, 2);
    }
}
