...
//
//   const weaponCurveExcelConfigDataType = Convert.toWeaponCurveExcelConfigDataType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export type WeaponCurveExcelConfigDataType = {
...
export class Convert {
    public static toWeaponCurveExcelConfigDataType(json: string): WeaponCurveExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("WeaponCurveExcelConfigDataType")));
    }

    public static weaponCurveExcelConfigDataTypeToJson(value: WeaponCurveExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("WeaponCurveExcelConfigDataType"))), null, 2);
    }
}
...
const typeMap: any = {
    "WeaponCurveExcelConfigDataType": o([
