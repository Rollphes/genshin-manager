...
export class Convert {
    public static toAvatarTalentExcelConfigDataType(json: string): AvatarTalentExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("AvatarTalentExcelConfigDataType")));
    }

    public static avatarTalentExcelConfigDataTypeToJson(value: AvatarTalentExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("AvatarTalentExcelConfigDataType"))), null, 2);
    }
}
