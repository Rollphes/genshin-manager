...
//
//   const profilePictureExcelConfigDataType = Convert.toProfilePictureExcelConfigDataType(json);
//
...
export class Convert {
    public static toProfilePictureExcelConfigDataType(json: string): ProfilePictureExcelConfigDataType[] {
        return cast(JSON.parse(json), a(r("ProfilePictureExcelConfigDataType")));
    }

    public static profilePictureExcelConfigDataTypeToJson(value: ProfilePictureExcelConfigDataType[]): string {
        return JSON.stringify(uncast(value, a(r("ProfilePictureExcelConfigDataType"))), null, 2);
    }
}
