 ...
 *
 */
export interface WeaponPromoteExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export class Convert {
   ...
   * @param json
   */
  public static toWeaponPromoteExcelConfigDataType(
    json: string,
  ): WeaponPromoteExcelConfigDataType[] {
   ...
   * @param value
   */
  public static weaponPromoteExcelConfigDataTypeToJson(
    value: WeaponPromoteExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('WeaponPromoteExcelConfigDataType'))),
      null,
      2,
    )
  }
