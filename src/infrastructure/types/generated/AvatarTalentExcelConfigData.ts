...
//
//   const avatarTalentExcelConfigDataType = Convert.toAvatarTalentExcelConfigDataType(json);
//
 ...
 *
 */
export interface AvatarTalentExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarTalentExcelConfigDataType(
    json: string,
  ): AvatarTalentExcelConfigDataType[] {
    return cast(JSON.parse(json), a(r('AvatarTalentExcelConfigDataType')))
  }
   ...
   * @param value
   */
  public static avatarTalentExcelConfigDataTypeToJson(
    value: AvatarTalentExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarTalentExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  ...
  PropType: ['FIGHT_PROP_CHARGE_EFFICIENCY', 'FIGHT_PROP_NONE'],
}
