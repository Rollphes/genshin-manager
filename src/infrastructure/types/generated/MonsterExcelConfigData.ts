 ...
 *
 */
export interface MonsterExcelConfigDataType {
  /**
   *
   */
  affix: number[]
...
export class Convert {
   ...
   * @param json
   */
  public static toMonsterExcelConfigDataType(
    json: string,
  ): MonsterExcelConfigDataType[] {
   ...
   * @param value
   */
  public static monsterExcelConfigDataTypeToJson(
    value: MonsterExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('MonsterExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  MonsterExcelConfigDataType: o(
    [
      ...
      {
        json: 'excludeWeathers',
        js: 'excludeWeathers',
        typ: r('ExcludeWeathers'),
      },
  ...
  SecurityLevel: ['BOSS', 'ELITE', 'NORMAL'],
  ServerScript: [
    '',
