 ...
 *
 */
export interface ReliquaryExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toReliquaryExcelConfigDataType(
    json: string,
  ): ReliquaryExcelConfigDataType[] {
   ...
   * @param value
   */
  public static reliquaryExcelConfigDataTypeToJson(
    value: ReliquaryExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('ReliquaryExcelConfigDataType'))),
      null,
      2,
    )
  }
