 ...
 *
 */
export interface AvatarExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarExcelConfigDataType(
    json: string,
   ...
   * @param value
   */
  public static avatarExcelConfigDataTypeToJson(
    value: AvatarExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  AvatarExcelConfigDataType: o(
    [
      {
        json: 'animatorConfigPathHash',
        js: 'animatorConfigPathHash',
        typ: 3.14,
      },
      { json: 'attackBase', js: 'attackBase', typ: 3.14 },
      {
        json: 'avatarIdentityType',
        js: 'avatarIdentityType',
        typ: r('AvatarIdentityType'),
      },
      { json: 'avatarPromoteId', js: 'avatarPromoteId', typ: 0 },
      {
        json: 'avatarPromoteRewardIdList',
        js: 'avatarPromoteRewardIdList',
        typ: a(0),
      },
      {
        json: 'avatarPromoteRewardLevelList',
        js: 'avatarPromoteRewardLevelList',
        typ: a(0),
      },
      ...
      {
        json: 'controllerPathRemoteHash',
        js: 'controllerPathRemoteHash',
        typ: 3.14,
      },
      ...
      {
        json: 'deformationMeshPathHash',
        js: 'deformationMeshPathHash',
        typ: 3.14,
      },
      ...
      { json: 'HCHFHPEKGHO', js: 'HCHFHPEKGHO', typ: 0 },
      ...
      { json: 'IJIPDMJLGNB', js: 'IJIPDMJLGNB', typ: 0 },
      ...
      { json: 'NCLJNCFOILK', js: 'NCLJNCFOILK', typ: 3.14 },
      ...
      { json: 'NOCDAKPNGFO', js: 'NOCDAKPNGFO', typ: 3.14 },
      ...
      {
        json: 'specialDeformationMeshPathHash',
        js: 'specialDeformationMeshPathHash',
        typ: 3.14,
      },
  ...
  AvatarIdentityType: ['AVATAR_IDENTITY_MASTER', 'AVATAR_IDENTITY_NORMAL'],
  ...
  QualityType: ['QUALITY_ORANGE', 'QUALITY_ORANGE_SP', 'QUALITY_PURPLE'],
  Tag: ['AVATAR_TAG_HEXENZIRKEL', 'AVATAR_TAG_MOONPHASE', 'None'],
  UseType: [
    'AVATAR_ABANDON',
    'AVATAR_FORMAL',
    'AVATAR_SYNC_TEST',
