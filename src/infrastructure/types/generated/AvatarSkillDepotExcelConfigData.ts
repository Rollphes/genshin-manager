...
//
//   const avatarSkillDepotExcelConfigDataType = Convert.toAvatarSkillDepotExcelConfigDataType(json);
//
 ...
 *
 */
export interface AvatarSkillDepotExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarSkillDepotExcelConfigDataType(
    json: string,
  ): AvatarSkillDepotExcelConfigDataType[] {
    return cast(JSON.parse(json), a(r('AvatarSkillDepotExcelConfigDataType')))
  }
   ...
   * @param value
   */
  public static avatarSkillDepotExcelConfigDataTypeToJson(
    value: AvatarSkillDepotExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarSkillDepotExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  AvatarSkillDepotExcelConfigDataType: o(
    [
      ...
      { json: 'leaderTalent', js: 'leaderTalent', typ: 0 },
      {
        ...
        js: 'inherentProudSkillOpens',
        typ: a(r('InherentProudSkillOpen')),
      },
  ...
  Ppmjamdeffo: ['Furina', 'None', 'Ousia', 'Pneuma'],
}
