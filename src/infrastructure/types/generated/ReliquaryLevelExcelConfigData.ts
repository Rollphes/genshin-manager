 ...
 *
 */
export interface ReliquaryLevelExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export class Convert {
   ...
   * @param json
   */
  public static toReliquaryLevelExcelConfigDataType(
    json: string,
  ): ReliquaryLevelExcelConfigDataType[] {
   ...
   * @param value
   */
  public static reliquaryLevelExcelConfigDataTypeToJson(
    value: ReliquaryLevelExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('ReliquaryLevelExcelConfigDataType'))),
      null,
      2,
    )
  }
