 ...
 *
 */
export interface AvatarSkillExcelConfigDataType {
  /**
   *
   */
  abilityName: string
...
export class Convert {
   ...
   * @param json
   */
  public static toAvatarSkillExcelConfigDataType(
    json: string,
  ): AvatarSkillExcelConfigDataType[] {
   ...
   * @param value
   */
  public static avatarSkillExcelConfigDataTypeToJson(
    value: AvatarSkillExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('AvatarSkillExcelConfigDataType'))),
      null,
      2,
    )
  }
...
const typeMap: any = {
  ...
  Gocdphlgkch: ['DurinBlack', 'DurinWhite', 'None'],
  Jmiajdgghmb: [
