 ...
 *
 */
export interface MonsterCurveExcelConfigDataType {
  /**
   *
   */
...
export class Convert {
   ...
   * @param json
   */
  public static toMonsterCurveExcelConfigDataType(
    json: string,
  ): MonsterCurveExcelConfigDataType[] {
   ...
   * @param value
   */
  public static monsterCurveExcelConfigDataTypeToJson(
    value: MonsterCurveExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('MonsterCurveExcelConfigDataType'))),
      null,
      2,
    )
  }
