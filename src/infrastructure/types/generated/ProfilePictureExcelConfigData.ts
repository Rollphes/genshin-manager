 ...
 *
 */
export interface ProfilePictureExcelConfigDataType {
  /**
   *
   */
  EKFIIIINJCD: boolean
...
export class Convert {
   ...
   * @param json
   */
  public static toProfilePictureExcelConfigDataType(
    json: string,
  ): ProfilePictureExcelConfigDataType[] {
   ...
   * @param value
   */
  public static profilePictureExcelConfigDataTypeToJson(
    value: ProfilePictureExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('ProfilePictureExcelConfigDataType'))),
      null,
      2,
    )
  }
