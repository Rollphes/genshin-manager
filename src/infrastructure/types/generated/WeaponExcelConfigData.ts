 ...
 *
 */
export interface WeaponExcelConfigDataType {
  /**
   *
   */
  awakenCosts: number[]
...
export class Convert {
   ...
   * @param json
   */
  public static toWeaponExcelConfigDataType(
    json: string,
  ): WeaponExcelConfigDataType[] {
   ...
   * @param value
   */
  public static weaponExcelConfigDataTypeToJson(
    value: WeaponExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('WeaponExcelConfigDataType'))),
      null,
      2,
    )
  }
