 ...
 *
 */
export interface EquipAffixExcelConfigDataType {
  /**
   *
   */
  addProps: AddProp[]
...
export class Convert {
   ...
   * @param json
   */
  public static toEquipAffixExcelConfigDataType(
    json: string,
  ): EquipAffixExcelConfigDataType[] {
   ...
   * @param value
   */
  public static equipAffixExcelConfigDataTypeToJson(
    value: EquipAffixExcelConfigDataType[],
  ): string {
    return JSON.stringify(
      uncast(value, a(r('EquipAffixExcelConfigDataType'))),
      null,
      2,
    )
  }
